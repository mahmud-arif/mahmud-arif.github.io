...
jobs:
  ...
  loto: {
    ...
    networkDiagram: {
      viewBox: "0 0 880 480",
      nodes: [
        { id: "user",  label: "User",            sublabel: "Public Internet",   color: "slate",   icon: "👤", x: 145, y: 55  },
        { id: "cf",    label: "Cloudflare",      sublabel: "DNS + CDN + WAF",   color: "orange",  icon: "🌐", x: 435, y: 55  },
        { id: "alb",   label: "AWS ALB",         sublabel: "Ingress Controller", color: "sky",     icon: "⚖️", x: 290, y: 175 },
        { id: "eks",   label: "EKS Cluster",     sublabel: "3× Node Groups",    color: "violet",  icon: "☸️", x: 510, y: 175 },
        { id: "argo",  label: "ArgoCD",          sublabel: "GitOps Deploy",     color: "rose",    icon: "🐙", x: 735, y: 175 },
        { id: "ecr",   label: "ECR",             sublabel: "Container Registry", color: "teal",   icon: "📦", x: 735, y: 295 },
        { id: "front", label: "tls-frontend",    sublabel: "Pods / Namespace",  color: "sky",     icon: "🖥️", x: 145, y: 295 },
        { id: "api",   label: "tls-backend",     sublabel: "Services / APIs",   color: "violet",  icon: "⚙️", x: 420, y: 295 },
        { id: "rds",   label: "RDS PostgreSQL",  sublabel: "Multi-AZ",          color: "emerald", icon: "🗄️", x: 290, y: 415 },
        { id: "obs",   label: "Loki + Grafana",  sublabel: "Logs + Metrics",    color: "amber",   icon: "📊", x: 540, y: 415 },
        { id: "atl",   label: "Atlantis",        sublabel: "Terraform GitOps",  color: "teal",    icon: "🏔️", x: 735, y: 415 },
      ],
      edges: [
        { from: "user",  to: "cf",    label: "HTTPS" },
        { from: "cf",    to: "alb",   label: "proxy" },
        { from: "alb",   to: "front", label: ":443" },
        { from: "alb",   to: "api",   label: ":443" },
        { from: "eks",   to: "front" },
        { from: "eks",   to: "api" },
        { from: "argo",  to: "eks",   label: "sync" },
        { from: "ecr",   to: "eks",   label: "pull",      dashed: true },
        { from: "api",   to: "rds",   label: "pg:5432" },
        { from: "eks",   to: "obs",   label: "logs/metrics", dashed: true },
...
workflows:
  ...
  travluence: {
    ...
    networkDiagram: {
      viewBox: "0 0 800 460",
      nodes: [
        { id: "user",  label: "User",            sublabel: "Public Internet",   color: "slate",   icon: "👤", x: 200, y: 55  },
        { id: "acm",   label: "ACM Certificate", sublabel: "us-east-1 / TLS",   color: "amber",   icon: "🔒", x: 520, y: 55  },
        { id: "r53",   label: "Route 53",        sublabel: "DNS A Alias",       color: "orange",  icon: "🌐", x: 145, y: 175 },
        { id: "waf",   label: "AWS WAF",         sublabel: "Web ACL",           color: "rose",    icon: "🛡️", x: 570, y: 175 },
        { id: "cf",    label: "CloudFront",      sublabel: "CDN Distribution",  color: "sky",     icon: "⚡", x: 355, y: 295 },
        { id: "s3",    label: "S3 Origin",       sublabel: "Static Site / OAI", color: "teal",    icon: "🪣", x: 175, y: 405 },
        { id: "log",   label: "S3 Logs",         sublabel: "Access Logs",       color: "slate",   icon: "📋", x: 430, y: 405 },
        { id: "gh",    label: "GitHub Actions",  sublabel: "OIDC → Terraform",  color: "violet",  icon: "⚙️", x: 650, y: 295 },
      ],
      edges: [
