...
export const projectDetails: Record<string, ProjectDetail> = {
  hakim: {
    ...
    networkDiagram: {
      cols: 4,
      nodes: [
        { id: "cf",    label: "Cloudflare DNS",   sublabel: "Proxied + SSL",    color: "orange",  icon: "🌐", row: 0, col: 1 },
        { id: "acm",   label: "ACM Certificate",  sublabel: "TLS 1.2",          color: "amber",   icon: "🔒", row: 0, col: 2 },
        { id: "alb",   label: "Public ALB",       sublabel: "HTTP→HTTPS",       color: "sky",     icon: "⚖️", row: 1, col: 0 },
        { id: "vpc",   label: "VPC",              sublabel: "10.x.0.0/20",      color: "teal",    icon: "🏗️", row: 1, col: 1 },
        { id: "nat",   label: "NAT Gateway",      sublabel: "Outbound",         color: "slate",   icon: "🔀", row: 1, col: 2 },
        { id: "ig",    label: "Internet GW",      sublabel: "Public Subnets",   color: "slate",   icon: "🌍", row: 1, col: 3 },
        { id: "ec2",   label: "EC2 t3.medium",    sublabel: "Private Subnet",   color: "violet",  icon: "🖥️", row: 2, col: 0 },
        { id: "rds",   label: "RDS PostgreSQL",   sublabel: "DB Subnet / gp3",  color: "emerald", icon: "🗄️", row: 2, col: 1 },
        { id: "sqs",   label: "SQS / SNS",        sublabel: "Event Bus + DLQ",  color: "amber",   icon: "📨", row: 2, col: 2 },
        { id: "s3",    label: "S3 Buckets",       sublabel: "Assets + Env",     color: "rose",    icon: "🪣", row: 2, col: 3 },
        { id: "cdep",  label: "CodeDeploy",       sublabel: "Blue/Green",       color: "sky",     icon: "🚀", row: 3, col: 0 },
        { id: "cw",    label: "CloudWatch",       sublabel: "Logs / Metrics",   color: "violet",  icon: "📊", row: 3, col: 1 },
        { id: "ecr",   label: "ECR",              sublabel: "Docker Images",    color: "teal",    icon: "📦", row: 3, col: 2 },
      ],
      edges: [
        ...
        { from: "vpc",  to: "ec2" },
        { from: "vpc",  to: "rds" },
        { from: "nat",  to: "ig",   label: "outbound", dashed: true },
        { from: "ec2",  to: "rds",  label: "pg:5432" },
        { from: "ec2",  to: "sqs",  label: "publish" },
        { from: "ec2",  to: "s3",   label: "assets",   dashed: true },
        { from: "cdep", to: "ec2",  label: "deploy" },
        { from: "ec2",  to: "cw",   label: "logs",     dashed: true },
...
module "booking_events_queue" {
  ...
  esim: {
    ...
    networkDiagram: {
      cols: 4,
      nodes: [
        { id: "cf",   label: "Cloudflare",       sublabel: "DNS + WAF",        color: "orange",  icon: "🌐", row: 0, col: 1 },
        { id: "acm",  label: "ACM / TLS",        sublabel: "Certificate",      color: "amber",   icon: "🔒", row: 0, col: 2 },
        { id: "alb",  label: "Public ALB",       sublabel: "Multi-AZ",         color: "sky",     icon: "⚖️", row: 1, col: 0 },
        { id: "vpc",  label: "VPC",              sublabel: "10.x.0.0/16",      color: "teal",    icon: "🏗️", row: 1, col: 1 },
        { id: "nat",  label: "NAT Gateway",      sublabel: "Private Egress",   color: "slate",   icon: "🔀", row: 1, col: 2 },
        { id: "ig",   label: "Internet GW",      sublabel: "Public Subnets",   color: "slate",   icon: "🌍", row: 1, col: 3 },
        { id: "ec2",  label: "EC2 Instances",    sublabel: "Private /24",      color: "violet",  icon: "🖥️", row: 2, col: 0 },
        { id: "rds",  label: "RDS PostgreSQL",   sublabel: "DB Subnet",        color: "emerald", icon: "🗄️", row: 2, col: 1 },
        { id: "sqs",  label: "SQS Queues",       sublabel: "+ DLQ",            color: "amber",   icon: "📨", row: 2, col: 2 },
        { id: "s3",   label: "S3",               sublabel: "Assets + Env",     color: "rose",    icon: "🪣", row: 2, col: 3 },
        { id: "cd",   label: "CodeDeploy",       sublabel: "Rolling Deploy",   color: "sky",     icon: "🚀", row: 3, col: 0 },
        { id: "cw",   label: "CloudWatch",       sublabel: "Logs + Alarms",    color: "violet",  icon: "📊", row: 3, col: 1 },
        { id: "ecr",  label: "ECR",              sublabel: "Docker Images",    color: "teal",    icon: "📦", row: 3, col: 2 },
      ],
      edges: [
        { from: "cf",  to: "alb",  label: "HTTPS" },
        ...
        { from: "ec2", to: "cw",   dashed: true },
        { from: "ecr", to: "ec2",  label: "pull",  dashed: true },
        { from: "nat", to: "ig",   dashed: true },
      ],
    },
    repoStructure: [
      {
...
jobs:
  ...
  loto: {
    ...
    networkDiagram: {
      cols: 4,
      nodes: [
        { id: "user",   label: "User / Browser",    sublabel: "Public Internet",     color: "slate",   icon: "👤", row: 0, col: 1 },
        { id: "cf",     label: "Cloudflare",         sublabel: "DNS + CDN + WAF",     color: "orange",  icon: "🌐", row: 0, col: 2 },
        { id: "alb",    label: "AWS ALB",            sublabel: "Ingress Controller",   color: "sky",     icon: "⚖️", row: 1, col: 0 },
        { id: "eks",    label: "EKS Cluster",        sublabel: "3× Node Groups",       color: "violet",  icon: "☸️", row: 1, col: 1 },
        { id: "argo",   label: "ArgoCD",            sublabel: "GitOps Deploy",        color: "rose",    icon: "🐙", row: 1, col: 2 },
        { id: "ecr",    label: "ECR",               sublabel: "Container Registry",   color: "teal",    icon: "📦", row: 1, col: 3 },
        { id: "front",  label: "tls-frontend",      sublabel: "Namespace: default",   color: "sky",     icon: "🖥️", row: 2, col: 0 },
        { id: "api",    label: "tls-backend",       sublabel: "Services / APIs",      color: "violet",  icon: "⚙️", row: 2, col: 1 },
        { id: "rds",    label: "RDS PostgreSQL",    sublabel: "Multi-AZ / DB Subnet", color: "emerald", icon: "🗄️", row: 2, col: 2 },
        { id: "s3",     label: "S3 + CloudFront",   sublabel: "Static CDN Assets",    color: "rose",    icon: "🪣", row: 2, col: 3 },
        { id: "loki",   label: "Loki",              sublabel: "Log Aggregation",      color: "amber",   icon: "📋", row: 3, col: 0 },
        { id: "prom",   label: "Prometheus",        sublabel: "Metrics Scrape",       color: "orange",  icon: "📊", row: 3, col: 1 },
        { id: "graf",   label: "Grafana",           sublabel: "Dashboards",          color: "amber",   icon: "📈", row: 3, col: 2 },
        { id: "atl",    label: "Atlantis",          sublabel: "Terraform GitOps",     color: "teal",    icon: "🏔️", row: 3, col: 3 },
      ],
      edges: [
        { from: "user",  to: "cf",    label: "HTTPS" },
        { from: "cf",    to: "alb",   label: "proxy" },
        { from: "alb",   to: "front", label: "80/443" },
        { from: "alb",   to: "api",   label: "80/443" },
        { from: "eks",   to: "front" },
        { from: "eks",   to: "api" },
        { from: "argo",  to: "eks",   label: "sync" },
        { from: "ecr",   to: "eks",   label: "pull",    dashed: true },
        { from: "api",   to: "rds",   label: "pg:5432" },
        { from: "front", to: "s3",    dashed: true },
        { from: "eks",   to: "loki",  label: "logs",    dashed: true },
        { from: "eks",   to: "prom",  label: "metrics", dashed: true },
        { from: "loki",  to: "graf" },
        { from: "prom",  to: "graf" },
...
workflows:
  ...
  travluence: {
    ...
    networkDiagram: {
      ...
      nodes: [
        { id: "user",  label: "User / Browser",  sublabel: "Public Internet",     color: "slate",   icon: "👤", row: 0, col: 1 },
        { id: "r53",   label: "Route 53",         sublabel: "DNS (A Alias)",       color: "orange",  icon: "🌐", row: 1, col: 0 },
        { id: "acm",   label: "ACM Certificate",  sublabel: "us-east-1 / TLS",     color: "amber",   icon: "🔒", row: 1, col: 1 },
        { id: "waf",   label: "AWS WAF",          sublabel: "Web ACL",             color: "rose",    icon: "🛡️", row: 1, col: 2 },
        { id: "cf",    label: "CloudFront",       sublabel: "CDN Distribution",    color: "sky",     icon: "⚡", row: 2, col: 1 },
        { id: "s3",    label: "S3 Origin",        sublabel: "Static Site / OAI",   color: "teal",    icon: "🪣", row: 3, col: 0 },
        { id: "log",   label: "S3 Log Bucket",    sublabel: "Access Logs",         color: "slate",   icon: "📋", row: 3, col: 1 },
        { id: "gh",    label: "GitHub Actions",   sublabel: "OIDC → Terraform",    color: "violet",  icon: "⚙️", row: 3, col: 2 },
      ],
      edges: [
        { from: "user", to: "r53",  label: "DNS lookup" },
        { from: "user", to: "waf",  label: "HTTPS" },
        { from: "r53",  to: "cf",   label: "Alias" },
        { from: "acm",  to: "cf",   label: "TLS cert" },
        { from: "waf",  to: "cf",   label: "filter" },
        { from: "cf",   to: "s3",   label: "OAI" },
        { from: "cf",   to: "log",  label: "logs",    dashed: true },
        { from: "gh",   to: "s3",   label: "sync",    dashed: true },
      ],
    },
    repoStructure: [
      {
...
module "cloudflare" {
  ...
  dataPipeline: {
    ...
    networkDiagram: {
      cols: 4,
      nodes: [
        { id: "rds1",  label: "RDS (FIB Remit)",   sublabel: "Source DB / AWS",     color: "violet",  icon: "🗄️", row: 0, col: 0 },
        { id: "rds2",  label: "RDS (FIB Kartat)",  sublabel: "Source DB / AWS",     color: "violet",  icon: "🗄️", row: 0, col: 3 },
        { id: "dms1",  label: "DMS Task",           sublabel: "Remit Replication",   color: "sky",     icon: "🔄", row: 1, col: 0 },
        { id: "peer",  label: "VPC Peering",        sublabel: "DMS ↔ Source VPCs",  color: "slate",   icon: "🔀", row: 1, col: 1 },
        { id: "s3",    label: "S3 Staging",         sublabel: "CSV / Parquet",       color: "rose",    icon: "🪣", row: 1, col: 2 },
        { id: "dms2",  label: "DMS Task",           sublabel: "Kartat Replication",  color: "sky",     icon: "🔄", row: 1, col: 3 },
        { id: "fn",    label: "Cloud Function",     sublabel: "GCS Trigger",         color: "amber",   icon: "⚡", row: 2, col: 1 },
        { id: "gcs",   label: "GCS Bucket",         sublabel: "Intermediate Store",  color: "teal",    icon: "🪣", row: 2, col: 2 },
        { id: "xfm",   label: "Transform Fn",       sublabel: "Normalize + Schema",  color: "amber",   icon: "🔧", row: 3, col: 0 },
        { id: "bq",    label: "BigQuery",           sublabel: "Data Warehouse",      color: "emerald", icon: "📊", row: 3, col: 1 },
        { id: "ds",    label: "BQ Datasets",        sublabel: "fib_remit / kartat",  color: "emerald", icon: "📋", row: 3, col: 2 },
        { id: "mon",   label: "Cloud Monitoring",   sublabel: "Alerts + Dashboards", color: "orange",  icon: "📈", row: 3, col: 3 },
      ],
      edges: [
        { from: "rds1", to: "dms1",  label: "CDC" },
        { from: "rds2", to: "dms2",  label: "CDC" },
        { from: "dms1", to: "peer",  label: "VPC" },
        { from: "dms2", to: "peer",  label: "VPC" },
        ...
        { from: "fn",   to: "xfm",   label: "invoke" },
        { from: "xfm",  to: "bq",    label: "load" },
