...
jobs:
  ...
  loto: {
    ...
    networkDiagram: {
      viewBox: "0 0 900 490",
      nodes: [
        { id: "user",  label: "User",              sublabel: "Public Internet",      color: "slate",   icon: "👤", x: 140, y: 55  },
        { id: "cf",    label: "Cloudflare",        sublabel: "DNS + CDN + DDoS",     color: "orange",  icon: "🌐", x: 440, y: 55  },
        { id: "atl",   label: "Atlantis",          sublabel: "Terraform GitOps",     color: "teal",    icon: "🏔️", x: 770, y: 55  },
        { id: "alb",   label: "AWS ALB",           sublabel: "LBC — internet-facing", color: "sky",    icon: "⚖️", x: 230, y: 185 },
        { id: "eks",   label: "EKS v1.31",         sublabel: "2× Node Groups",       color: "violet",  icon: "☸️", x: 490, y: 185 },
        { id: "argo",  label: "ArgoCD",            sublabel: "GitOps / SAML SSO",    color: "rose",    icon: "🐙", x: 770, y: 185 },
        { id: "front", label: "tls-frontend",      sublabel: "K8s Pod / Namespace",  color: "sky",     icon: "🖥️", x: 130, y: 310 },
        { id: "svc",   label: "tls-* Services",    sublabel: "6× microservices",     color: "violet",  icon: "⚙️", x: 380, y: 310 },
        { id: "ecr",   label: "ECR",               sublabel: "Cross-acct Registry",  color: "teal",    icon: "📦", x: 630, y: 310 },
        { id: "rds",   label: "RDS PostgreSQL",    sublabel: "loto-<workspace>",     color: "emerald", icon: "🗄️", x: 175, y: 425 },
        { id: "obs",   label: "Loki + Prometheus", sublabel: "Logs + Metrics (S3)",  color: "amber",   icon: "📊", x: 430, y: 425 },
        { id: "graf",  label: "Managed Grafana",   sublabel: "Dashboards + SSO",     color: "orange",  icon: "📈", x: 700, y: 425 },
      ],
      edges: [
        ...
        { from: "obs",   to: "graf" },
        { from: "atl",   to: "eks",   label: "tf infra",    dashed: true },
      ],
    },
    repoStructure: [
      {
